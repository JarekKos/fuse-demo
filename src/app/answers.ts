const answers = [
  {
    text: 'No. You may have received an erroneous message about a "patriotic can" that Pepsi allegedly ' +
    'produced with an edited version of America’s Pledge of Allegiance. The truth is, ' +
    'Pepsi never produced such a can. In fact, this is a hoax that has been circulating on the Internet ' +
  ...
  {
    text: 'While Pepsi ONE has been discontinued, we do want to share that Diet Pepsi has been reformulated ' +
    'and aspartame has been removed. With its light, crisp taste, Diet Pepsi gives you all the refreshment ' +
    'you need - with zero sugar, zero calories and zero carbs.',
    tags: ['secondAnswer']
  },
  {
  ...
  {
    text: 'Thanks for your interest in Pepsi! If you’re a student looking for information on one of our ' +
    'brands or products, you should check out our Corporate website. Financial information such as our annual ' +
  ...
  {
    text: 'All of our products have a "Best taste date," which is very different from an expiration date ' +
    'often found on perishable items such as dairy and meat products.  Our "Best taste date" is a self-imposed ' +
    'indicator that has been listed on the underside of our cans, shoulders of bottles and sides of paperboard ' +
    'wraps since 1994.  We provide this information simply to help ensure that our products are consumed at ' +
